...
WANDB_API_KEY = os.environ.get("f5439d8b2650ef45b16d2ac72da5c51a8951a074", None)  # Your W&B API key
WANDB_PROJECT = os.environ.get("ukupdm-technical-university-of-berlin/intro-example", None)  # Your W&B project name
# ============================================================================
